...
public class BiddingService {
     ...
     * Get unread notification count for a user
     */
    public ApiResponse<Map<String, Object>> getUnreadNotificationCount(String userId) {
        try {
            ...
            return new ApiResponse<>(true, "Unread count retrieved successfully", response);
            
        } catch (Exception e) {
            System.err.println("Error getting unread notification count: " + e.getMessage());
            e.printStackTrace();
            return new ApiResponse<>(false, "Failed to get unread count: " + e.getMessage(), null);
        }
    }
    ...
    public ApiResponse<String> markAllNotificationsAsRead(String userId) {
        try {
            ...
            return new ApiResponse<>(true, 
                "Marked " + unreadNotifications.size() + " notifications as read", "Success");
